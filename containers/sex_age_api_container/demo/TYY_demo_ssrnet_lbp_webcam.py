...
def main():
    ...
    # capture video
    cap = cv2.VideoCapture('/media/sidorov/dev/PycharmProjects/SSR-Net/media_content/vid_vert_fix.mp4')
    # cap.set(cv2.CAP_PROP_FRAME_WIDTH, 1024*1)
    # cap.set(cv2.CAP_PROP_FRAME_HEIGHT, 768*1)
    cap.set(cv2.CAP_PROP_FRAME_WIDTH, 720*1)
    cap.set(cv2.CAP_PROP_FRAME_HEIGHT, 1280*1)
    ...
    time_network = 0
    time_plot = 0
    skip_frame = 5 # every 5 frame do 1 detection and network forward propagation Поставить 0 для картинок!!!!
    ad = 0.5
